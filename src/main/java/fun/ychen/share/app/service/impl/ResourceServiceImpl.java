...
import fun.ychen.share.app.convert.ResourceConvert;
import fun.ychen.share.app.enums.ResourceStatusEnum;
...
import static fun.ychen.share.app.common.constant.Constant.NO_TOKEN;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceMapper, Resource> implements ResourceService {
    ...
    public PageResult<ResourceItemVO> getUserActionResourcePage(UserActionResourceQuery query) {
        ...
        UserActionListInfo userActionListInfo = userActionService.selectResourceListByUserIdAndType(userId, UserActionEnum.getByCode(query.getType()), new Page<>(query.getPage(), query.getLimit()));
        // 查询结果为空，直接返回空
